...
set(lwipcontribportchino_SRCS
    ${LWIP_CONTRIB_DIR}/ports/chino/port/sys_arch.cpp
...
target_include_directories(lwipcontribportchino PRIVATE ${LWIP_INCLUDE_DIRS} ${LWIP_MBEDTLS_INCLUDE_DIRS} ${CHINO_DDK_INCLUDE_DIR})
...
target_link_libraries(lwipcontribportchino PUBLIC ${LWIP_MBEDTLS_LINK_LIBRARIES} c c.host cxx_static)
